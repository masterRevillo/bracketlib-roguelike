...
impl HungerSystem {
    pub fn calculate_new_hunger_state(
        current_points: i32,
        current_state: HungerState,
        food_points: i32,
    ) -> (HungerState, i32) {
...
impl<'a> System<'a> for HungerSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (entities, mut hunger_clock, player_entity, runstate, mut inflict_damage, mut gamelog) =
            data;
                        ...
                        HungerState::Starving => {
                            ...
                            if entity == *player_entity {
                                gamelog.entries.push(
                                    "You are dying of starvation. You take 1 hp of damage"
                                        .to_string(),
                                );
                            }
